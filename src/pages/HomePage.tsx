        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <motion.div
              ...
              className="p-6"
            >
              <div className="text-3xl font-bold text-blue-900 mb-2">2025</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <Link 
                to="/services" 
                className="text-blue-900 font-semibold hover:text-blue-700 flex items-center space-x-1"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="text-blue-200">Officially registered with Ministry of Defence</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-blue-200">Led by retired military and police officers</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-blue-200">Rigorous training programs for all personnel</p>
            </motion.div>
